...
#include <stdlib.h>
#include <time.h>
#include "Project-2/Project_Knapsack-2.h" 
#include "Item.h"
...
int main(int argc, char* argv[]) {
    ...
    double initial_mutation_rate = 0.001;
    ...
    // Calculate and display the total weight of the selected items
    int total_weight = 0;
    for (int i = 0; i < n; ++i) {
        if (items[i].isPick == 1) {  // Use isPick to check if the item is selected
